...
//when a timeslot gets clicked, the book function gets enabled
function book() { 
    alert("Hello world");
}


//fills the row with the hours
...
//the given timeslots variable is an array of json objects -> each object is a timeslot and it's attributes are: id, availability, date hour
...
let fetchTablehours = () => { 
    fetch('/booking/hours')     //the fetched result is a list of strings
    .then(
